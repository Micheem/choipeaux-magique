...
def validation_croisee(table):
    ...
    for test in range(nb_test):
        ...
        for eleve in test_set:
            if maison(train_set, eleve) == eleve['House']:
                ça_fonctionne += 1
...
while a == 1:
    ...
    if mode.lower() == 'd':
        ...
        if rep.lower() == 'a':
            ...
            copie1 = voisins1[:k]
            affichage(copie1)
            print(f"La maison attribué à cet élève est {maison(poudlard_characters, eleve_random1)}")
        ...
        if rep.lower() == 'b':
            ...
            copie2 = voisins2[:k]
            affichage(copie2)
            print(f"La maison attribué à cet élève est {maison(poudlard_characters, eleve_random2)}")
            validation_croisee(poudlard_characters)
            print()
            reps = input("Veux tu réessayer? [y] [n]")
            if reps.lower() == 'y':
        ...
        if rep.lower() == 'c':
            ...
            copie3 = voisins3[:k]
            affichage(copie3)
            print(f"La maison attribué à cet élève est {maison(poudlard_characters, eleve_random3)}")
            validation_croisee(poudlard_characters)
            print()
            reps = input("Veux tu réessayer? [y] [n]: ")
            if reps.lower() == 'y':
        ...
        if rep.lower() == 'd':
            ...
            copie4 = voisins4[:k]
            affichage(copie4)
            print(f"La maison attribué à cet élève est {maison(poudlard_characters, eleve_random4)}")
            validation_croisee(poudlard_characters)
            print()
            reps = input("Veux tu réessayer? [y] [n]: ")
            if reps.lower() == 'y':
        ...
        if rep.lower() == 'e':
            ...
            copie5 = voisins5[:k]
            affichage(copie5)
            print(f"La maison attribué à cet élève est {maison(poudlard_characters, eleve_random5)}")
            validation_croisee(poudlard_characters)
            print()
            reps = input("Veux tu réessayer? [y] [n]: ")
            if reps.lower() == 'y':
    ...
    if mode.lower() == 'p':
        ...
        print(f"La maison attribué à cet élève est {maison(poudlard_characters, eleve_perso)}")
        validation_croisee(poudlard_characters)
        print()
        reps = input("Veux tu réessayer? [y] [n]: ")
        if reps.lower() == 'y':
