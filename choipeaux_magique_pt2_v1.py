...
def affichage(table, eleve):
    ...
    for dico in table:
        ...
        print(
            ...
            f"{bcolors.g + bcolors.indigo} Intelligence{bcolors.reset} : {intelligence}|{bcolors.g + bcolors.vert} Good{bcolors.reset} : {good}|"
            f"{bcolors.g + bcolors.rose} Distance{bcolors.reset} : {distance}|{bcolors.g + bcolors.cyan} Maison{bcolors.reset} : {house}")
